...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('penjualans', function (Blueprint $table) {
            ...
            $table->foreignId('pelanggan_id')->nullable()->constrained()->cascadeOnDelete()->noActionOnUpdate();
            $table->foreignId('produk_id')->nullable()->constrained()->cascadeOnDelete()->noActionOnUpdate();
